namespace ErisHU.BaseStrategy.StackStageStrategies
{
    ...
    public static class MiddleStackStrategy
    {
        ...
        */
        ...
        {  // A  K  Q  J  T  9  8  7  6  5  4  3  2
            ...
            { 7, 6, 7, 6, 6, 6, 6, 5, 5, 5, 5, 5, 5 }, // Q
            { 6, 6, 6, 7, 6, 6, 6, 5, 5, 5, 5, 5, 5 }, // J
            { 6, 6, 6, 6, 6, 6, 6, 5, 5, 5, 5, 5, 5 }, // T
            { 6, 6, 5, 5, 5, 6, 5, 5, 5, 5, 1, 0, 0 }, // 9
            { 6, 5, 5, 5, 5, 5, 6, 5, 5, 5, 1, 0, 0 }, // 8
            { 6, 5, 5, 5, 5, 5, 5, 6, 5, 5, 5, 0, 0 }, // 7
            { 6, 5, 5, 2, 2, 2, 2, 5, 6, 5, 5, 0, 0 }, // 6
            { 6, 5, 5, 0, 0, 0, 0, 0, 0, 6, 5, 1, 0 }, // 5
            { 5, 5, 5, 0, 0, 0, 0, 0, 0, 0, 3, 0, 0 }, // 4
        ...
        {  // A   K   Q   J   T   9   8   7   6  5  4   3   2
            ...
            { 12, 10, 12, 10, 10, 10, 10, 9,  9,  9,  9,  9,  9 },  // Q
            { 10, 10, 10, 12, 10, 10, 9,  9,  9,  9,  9,  0,  0 },  // J
            { 10, 10, 10, 10, 10, 10, 9,  9,  9,  9,  0,  0,  0 },  // T
            { 10, 10, 10, 9,  9,  10, 9,  9,  9,  9,  0,  0,  0 },  // 9
            { 10, 9,  9,  9,  9,  9,  10, 9,  9,  9,  9,  0,  0 },  // 8
            { 10, 9,  9,  9,  9,  9,  9,  10, 9,  9,  9,  0,  0 },  // 7
            { 10, 9,  9,  9,  9,  0,  0,  9,  10, 9,  9,  0,  0 },  // 6
            { 10, 9,  9,  0,  0,  0,  0,  0,  0,  10, 9,  0,  0 },  // 5
            { 10, 9,  0,  0,  0,  0,  0,  0,  0,  0,  9,  0,  0 },  // 4
       ...
       {   // A  K   Q   J   T   9   8   7   6   5   4   3   2
            ...
            { 7, 6,  7,  6,  6,  6,  6,  13, 13, 13, 13, 13, 13 }, // Q
            ...
            { 6, 13, 13, 13, 13, 13, 13, 13, 6,  13, 13, 13, 13 }, // 6
            { 6, 13, 13, 13, 13, 13, 13, 13, 13, 6,  13, 13, 13 }, // 5
            { 5, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13 }, // 4
            { 5, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13 }, // 3
            { 5, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13 }, // 2
        };
        ...
        public static PlayerAction GetFlopAction(GetActionContext context)
        {
            ...
            if (FoldHands.Any(h => h == handStrength))
            {
        ...
        private static PlayerAction RecognitionFirstAction(GetActionContext context)
        {
            ...
            switch (behaviourValue)
            {
                ...
                case 5: return PlayerAction.Raise(bigBlind * 2);
                case 6: return PlayerAction.Raise(bigBlind * 2);
                case 7: return PlayerAction.Raise(bigBlind * 2);
        ...
        private static readonly HandStrengthType[] FoldHands =
            {
