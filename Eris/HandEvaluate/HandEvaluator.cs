namespace HandEvaluate
{
    ...
    public static class HandEvaluator
    {
        ...
        public static HandStrengthType FourOfAKindSubTypeRecognition(Card firstCard, Card secondCard, IReadOnlyCollection<Card> board)
        {
            ...
            {
                var fourOfAKindCard = board.First(x => board.Count(y => y.Type == x.Type) == 4);
                ...
                var kickerOnTheBoard = board.First(x => board.Count(y => y.Type == x.Type) == 1);
        ...
        public static HandStrengthType FullHouseSubTypeRecognition(Card firstCard, Card secondCard, IReadOnlyCollection<Card> board)
        {
            ...
            {
                var tripsCard = board.First(x => board.Count(y => y.Type == x.Type) == 3);
                var pairCard = board.First(x => board.Count(y => y.Type == x.Type) == 2);
            ...
            if (pairsOnBoard == 2)
            {
                var firstPairCard = board.First(x => board.Count(y => y.Type == x.Type) == 2);
                var secondPairCard = board.First(x => board.Count(y => y.Type == x.Type && firstPairCard.Type != x.Type) == 2);
        ...
        {
            var flushSuit = board.First(x => board.Count(y => y.Suit == x.Suit) >= MinimumSuitedCardsOnTheBoardForFlush).Suit;
        ...
        public static HandStrengthType StraightSubTypeRecognition(Card firstCard, Card secondCard, IReadOnlyCollection<Card> board)
        {
            ...
            {
                var myStraightCard = bestStraight.First(c => !board.Any(x => x.Type == c));
        ...
        public static HandStrengthType TwoPairsSubTypeRecognition(Card firstCard, Card secondCard, IReadOnlyCollection<Card> board)
        {
            ...
            if (pairsOnBoard == 2)
            {
                ...
                var firstPairType = board.First(x => board.Count(y => y.Type == x.Type) == 2).Type;
                var secondPairType = board.First(x => board.Count(y => y.Type == x.Type && firstPairType != x.Type) == 2).Type;
            ...
            {
                bool myCardsAreEqual = firstCard.Type == secondCard.Type;
                var pairType = board.First(x => board.Count(y => y.Type == x.Type) == 2).Type;
        ...
        public static HandStrengthType OnePairSubTypeRecognition(Card firstCard, Card secondCard, IReadOnlyCollection<Card> board)
        {
            ...
            if (pairsOnBoard == 0)
            {
                ...
                {
                    var pairCard = board.First(c => c.Type == firstCard.Type || c.Type == secondCard.Type);
                    var orderedBoard = board.OrderBy(x => x.Type).ToArray();
